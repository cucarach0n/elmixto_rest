...
from apps.usuario.api.serializers.user_serializers import UserTokenSerializer
    ...
    def post(self,request,*args,**kwargs):
        ...
        if login_serializer.is_valid():
            ...
            if user.habilitado:
                ...
                return Response({'error':'Este usuario se ecnuentra deshabilitado'},status = status.HTTP_401_UNAUTHORIZED)
        else:
